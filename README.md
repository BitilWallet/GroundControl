...
Built with typescript, expressjs, mariadb & [openapi](https://editor.swagger.io/?url=https://raw.githubusercontent.com/BitilWallet/GroundControl/master/openapi.yaml).
...
- `APNS_TOPIC` for example `io.bitilwallet.bitilwallet`
